...
module fqcodel
	...
	// Largest single-step arrival burst IQ5 has ever received (monotone).
	...
	[REC_PKT_GET_IQ5] stage=REC_PKT_GET_IQ5 & (time=4|time=5|time=6|time=7|time=8|time=9|time=10|time=11|time=12|time=13) -> (stage'=REC_PKT_ARR_IQ5) & (iq5_arrivals'=1);
	[REC_PKT_GET_IQ5b] stage=REC_PKT_GET_IQ5 & !(time=4|time=5|time=6|time=7|time=8|time=9|time=10|time=11|time=12|time=13) -> (stage'=REC_PKT_ARR_IQ5) & (iq5_arrivals'=0);
	...
	[REC_PKT_ARR_IQ5_K3] stage=REC_PKT_ARR_IQ5 & iq5_arrivals=3 -> (stage'=REC_UPD_NEW_IQ5) & (iq5_contents'=min(SZ,iq5_contents+3)) & (iq5_cenq'=iq5_cenq+3) & (iq5_aipg'=0) & (iq5_max_arr'=max(iq5_max_arr,3));
	[REC_PKT_ARR_IQ5_K4] stage=REC_PKT_ARR_IQ5 & iq5_arrivals=4 -> (stage'=REC_UPD_NEW_IQ5) & (iq5_contents'=min(SZ,iq5_contents+4)) & (iq5_cenq'=iq5_cenq+4) & (iq5_aipg'=0) & (iq5_max_arr'=max(iq5_max_arr,4));
