...
module fqcodel
	...
	[REC_PKT_GET_IQ5] stage=REC_PKT_GET_IQ5 & time<=3 -> (stage'=REC_PKT_ARR_IQ5) & (iq5_arrivals'=0);
	[REC_PKT_GET_IQ5b] stage=REC_PKT_GET_IQ5 & time>3 -> 0.40 : (stage'=REC_PKT_ARR_IQ5) & (iq5_arrivals'=0) + 0.60 : (stage'=REC_PKT_ARR_IQ5) & (iq5_arrivals'=1);
