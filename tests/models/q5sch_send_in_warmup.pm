...
module fqcodel
	...
	[REC_PKT_GET_IQ5] stage=REC_PKT_GET_IQ5 & (time=0|time=4|time=8|time=12) -> (stage'=REC_PKT_ARR_IQ5) & (iq5_arrivals'=1);
	[REC_PKT_GET_IQ5b] stage=REC_PKT_GET_IQ5 & !(time=0|time=4|time=8|time=12) -> (stage'=REC_PKT_ARR_IQ5) & (iq5_arrivals'=0);
