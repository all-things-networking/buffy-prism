...
module fqcodel
	...
	[DEQ_FROM_NEW_IQ1_DROP]   stage=DEQ & deq_iq1_from_new_list & iq1_contents=1 -> (stage'=REC_PKT_GET_IQ1) & (iq1_contents'=0) & (iq1_new_rank'=0) & (iq2_new_rank'=max(0,iq2_new_rank-1)) & (iq3_new_rank'=max(0,iq3_new_rank-1)) & (iq4_new_rank'=max(0,iq4_new_rank-1)) & (iq5_new_rank'=max(0,iq5_new_rank-1)) & (new_list_len'=max(0,new_list_len-1)) & (iq1_arrivals'=0) & (iq2_arrivals'=0) & (iq3_arrivals'=0) & (iq4_arrivals'=0) & (iq5_arrivals'=0);
	[DEQ_FROM_NEW_IQ2_DROP]   stage=DEQ & deq_iq2_from_new_list & iq2_contents=1 -> (stage'=REC_PKT_GET_IQ1) & (iq2_contents'=0) & (iq2_new_rank'=0) & (iq1_new_rank'=max(0,iq1_new_rank-1)) & (iq3_new_rank'=max(0,iq3_new_rank-1)) & (iq4_new_rank'=max(0,iq4_new_rank-1)) & (iq5_new_rank'=max(0,iq5_new_rank-1)) & (new_list_len'=max(0,new_list_len-1)) & (iq1_arrivals'=0) & (iq2_arrivals'=0) & (iq3_arrivals'=0) & (iq4_arrivals'=0) & (iq5_arrivals'=0);
	[DEQ_FROM_NEW_IQ3_DROP]   stage=DEQ & deq_iq3_from_new_list & iq3_contents=1 -> (stage'=REC_PKT_GET_IQ1) & (iq3_contents'=0) & (iq3_new_rank'=0) & (iq1_new_rank'=max(0,iq1_new_rank-1)) & (iq2_new_rank'=max(0,iq2_new_rank-1)) & (iq4_new_rank'=max(0,iq4_new_rank-1)) & (iq5_new_rank'=max(0,iq5_new_rank-1)) & (new_list_len'=max(0,new_list_len-1)) & (iq1_arrivals'=0) & (iq2_arrivals'=0) & (iq3_arrivals'=0) & (iq4_arrivals'=0) & (iq5_arrivals'=0);
	[DEQ_FROM_NEW_IQ4_DROP]   stage=DEQ & deq_iq4_from_new_list & iq4_contents=1 -> (stage'=REC_PKT_GET_IQ1) & (iq4_contents'=0) & (iq4_new_rank'=0) & (iq1_new_rank'=max(0,iq1_new_rank-1)) & (iq2_new_rank'=max(0,iq2_new_rank-1)) & (iq3_new_rank'=max(0,iq3_new_rank-1)) & (iq5_new_rank'=max(0,iq5_new_rank-1)) & (new_list_len'=max(0,new_list_len-1)) & (iq1_arrivals'=0) & (iq2_arrivals'=0) & (iq3_arrivals'=0) & (iq4_arrivals'=0) & (iq5_arrivals'=0);
	[DEQ_FROM_NEW_IQ1_TO_OLD] stage=DEQ & deq_iq1_from_new_list & iq1_contents>1 -> (stage'=REC_PKT_GET_IQ1) & (iq1_contents'=max(0,iq1_contents-1)) & (iq1_new_rank'=0) & (iq2_new_rank'=max(0,iq2_new_rank-1)) & (iq3_new_rank'=max(0,iq3_new_rank-1)) & (iq4_new_rank'=max(0,iq4_new_rank-1)) & (iq5_new_rank'=max(0,iq5_new_rank-1)) & (new_list_len'=max(0,new_list_len-1)) & (iq1_old_rank'=min(IQS,old_list_len+1)) & (old_list_len'=min(IQS,old_list_len+1)) & (iq1_arrivals'=0) & (iq2_arrivals'=0) & (iq3_arrivals'=0) & (iq4_arrivals'=0) & (iq5_arrivals'=0);
	...
	[DEQ_FROM_NEW_IQ5_DROP_NOBL]   stage=DEQ & deq_iq5_from_new_list & iq5_contents=1 & !iqs_bl -> (stage'=REC_PKT_GET_IQ1) & (iq5_contents'=0) & (iq5_new_rank'=0) & (iq2_new_rank'=max(0,iq2_new_rank-1)) & (iq1_new_rank'=max(0,iq1_new_rank-1)) & (iq3_new_rank'=max(0,iq3_new_rank-1)) & (iq4_new_rank'=max(0,iq4_new_rank-1)) & (new_list_len'=max(0,new_list_len-1)) & (iq1_arrivals'=0) & (iq2_arrivals'=0) & (iq3_arrivals'=0) & (iq4_arrivals'=0) & (iq5_arrivals'=0);
	...
	[DEQ_FROM_OLD_IQ1_DROP]   stage=DEQ & deq_iq1_from_old_list & iq1_contents=1 -> (stage'=REC_PKT_GET_IQ1) & (iq1_contents'=0) & (iq1_old_rank'=0) & (iq2_old_rank'=max(0,iq2_old_rank-1)) & (iq3_old_rank'=max(0,iq3_old_rank-1)) & (iq4_old_rank'=max(0,iq4_old_rank-1)) & (iq5_old_rank'=max(0,iq5_old_rank-1)) & (old_list_len'=max(0,old_list_len-1)) & (iq1_arrivals'=0) & (iq2_arrivals'=0) & (iq3_arrivals'=0) & (iq4_arrivals'=0) & (iq5_arrivals'=0);
	[DEQ_FROM_OLD_IQ1_TO_OLD] stage=DEQ & deq_iq1_from_old_list & iq1_contents>1 -> (stage'=REC_PKT_GET_IQ1) & (iq1_contents'=max(0,iq1_contents-1)) & (iq2_old_rank'=max(0,iq2_old_rank-1)) & (iq3_old_rank'=max(0,iq3_old_rank-1)) & (iq4_old_rank'=max(0,iq4_old_rank-1)) & (iq5_old_rank'=max(0,iq5_old_rank-1)) & (iq1_old_rank'=old_list_len) & (iq1_arrivals'=0) & (iq2_arrivals'=0) & (iq3_arrivals'=0) & (iq4_arrivals'=0) & (iq5_arrivals'=0);
	...
	[DEQ_NOP] stage=DEQ & lists_empty -> (stage'=REC_PKT_GET_IQ1) & (iq1_arrivals'=0) & (iq2_arrivals'=0) & (iq3_arrivals'=0) & (iq4_arrivals'=0) & (iq5_arrivals'=0);
endmodule
