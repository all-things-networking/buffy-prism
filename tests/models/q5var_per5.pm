...
module fqcodel
	...
	[REC_PKT_GET_IQ5] stage=REC_PKT_GET_IQ5 & mod(iq5_clk,5)=0 -> (stage'=REC_PKT_ARR_IQ5) & (iq5_arrivals'=1) & (iq5_clk'=mod(iq5_clk+1,5));
	[REC_PKT_GET_IQ5b] stage=REC_PKT_GET_IQ5 & mod(iq5_clk,5)!=0 -> (stage'=REC_PKT_ARR_IQ5) & (iq5_arrivals'=0) & (iq5_clk'=mod(iq5_clk+1,5));
