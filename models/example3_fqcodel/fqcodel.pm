// Buggy FQ-CoDel AQM algorithm -- example 3 (worst-case starvation via LCRL)
// Adapted from tests/models/fqcodel_5i_mdp.pm: DEQ guarded by time<TIME_STEPS
// + terminal [end] self-loop + "done" label so the simulator terminates
// (StormPy's simulator does not enforce the [0..TIME_STEPS] range on time).
...
module fqcodel
	...
	[REC_PKT_GET_IQ1] stage=REC_PKT_GET_IQ1 -> (stage'=REC_PKT_ARR_IQ1) & (iq1_arrivals'=0);
	[REC_PKT_GET_IQ1] stage=REC_PKT_GET_IQ1 -> (stage'=REC_PKT_ARR_IQ1) & (iq1_arrivals'=1);
	[REC_PKT_GET_IQ1] stage=REC_PKT_GET_IQ1 -> (stage'=REC_PKT_ARR_IQ1) & (iq1_arrivals'=2);
	[REC_PKT_GET_IQ1] stage=REC_PKT_GET_IQ1 -> (stage'=REC_PKT_ARR_IQ1) & (iq1_arrivals'=3);
	[REC_PKT_GET_IQ1] stage=REC_PKT_GET_IQ1 -> (stage'=REC_PKT_ARR_IQ1) & (iq1_arrivals'=4);
	...
	[REC_PKT_GET_IQ2] stage=REC_PKT_GET_IQ2 -> (stage'=REC_PKT_ARR_IQ2) & (iq2_arrivals'=0);
	[REC_PKT_GET_IQ2] stage=REC_PKT_GET_IQ2 -> (stage'=REC_PKT_ARR_IQ2) & (iq2_arrivals'=1);
	[REC_PKT_GET_IQ2] stage=REC_PKT_GET_IQ2 -> (stage'=REC_PKT_ARR_IQ2) & (iq2_arrivals'=2);
	[REC_PKT_GET_IQ2] stage=REC_PKT_GET_IQ2 -> (stage'=REC_PKT_ARR_IQ2) & (iq2_arrivals'=3);
	[REC_PKT_GET_IQ2] stage=REC_PKT_GET_IQ2 -> (stage'=REC_PKT_ARR_IQ2) & (iq2_arrivals'=4);
	...
	[REC_PKT_GET_IQ3] stage=REC_PKT_GET_IQ3 -> (stage'=REC_PKT_ARR_IQ3) & (iq3_arrivals'=0);
	[REC_PKT_GET_IQ3] stage=REC_PKT_GET_IQ3 -> (stage'=REC_PKT_ARR_IQ3) & (iq3_arrivals'=1);
	[REC_PKT_GET_IQ3] stage=REC_PKT_GET_IQ3 -> (stage'=REC_PKT_ARR_IQ3) & (iq3_arrivals'=2);
	[REC_PKT_GET_IQ3] stage=REC_PKT_GET_IQ3 -> (stage'=REC_PKT_ARR_IQ3) & (iq3_arrivals'=3);
	[REC_PKT_GET_IQ3] stage=REC_PKT_GET_IQ3 -> (stage'=REC_PKT_ARR_IQ3) & (iq3_arrivals'=4);
	...
	[REC_PKT_GET_IQ4] stage=REC_PKT_GET_IQ4 -> (stage'=REC_PKT_ARR_IQ4) & (iq4_arrivals'=0);
	[REC_PKT_GET_IQ4] stage=REC_PKT_GET_IQ4 -> (stage'=REC_PKT_ARR_IQ4) & (iq4_arrivals'=1);
	[REC_PKT_GET_IQ4] stage=REC_PKT_GET_IQ4 -> (stage'=REC_PKT_ARR_IQ4) & (iq4_arrivals'=2);
	[REC_PKT_GET_IQ4] stage=REC_PKT_GET_IQ4 -> (stage'=REC_PKT_ARR_IQ4) & (iq4_arrivals'=3);
	[REC_PKT_GET_IQ4] stage=REC_PKT_GET_IQ4 -> (stage'=REC_PKT_ARR_IQ4) & (iq4_arrivals'=4);
	...
	[REC_PKT_GET_IQ5] stage=REC_PKT_GET_IQ5 -> (stage'=REC_PKT_ARR_IQ5) & (iq5_arrivals'=0);
	[REC_PKT_GET_IQ5] stage=REC_PKT_GET_IQ5 -> (stage'=REC_PKT_ARR_IQ5) & (iq5_arrivals'=1);
	[REC_PKT_GET_IQ5] stage=REC_PKT_GET_IQ5 -> (stage'=REC_PKT_ARR_IQ5) & (iq5_arrivals'=2);
	[REC_PKT_GET_IQ5] stage=REC_PKT_GET_IQ5 -> (stage'=REC_PKT_ARR_IQ5) & (iq5_arrivals'=3);
	[REC_PKT_GET_IQ5] stage=REC_PKT_GET_IQ5 -> (stage'=REC_PKT_ARR_IQ5) & (iq5_arrivals'=4);
